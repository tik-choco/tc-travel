...
export function CelebrationHost() {
  ...
  const fingerprint = `${japanSettled}|${rank.level}|${stats.streakDays}|${unlockedIds.join(",")}`;
  ...
  useEffect(() => {
    ...
    const next: CelebrationLedger = { level: rank.level, achievements: unlockedIds, streakDays: stats.streakDays };

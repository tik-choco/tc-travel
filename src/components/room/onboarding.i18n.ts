...
export const onboardingTranslations = {
  ...
  "onboarding.welcomeBody1": {
    en: "This is your travel chronicle — record every place, photo and story from your travels, and watch the world map fill in as you go.",
    ja: "ここはあなたの冒険の記録。旅先の場所や写真、物語を記録すると、世界地図が少しずつ彩られていきます。",
    zh: "这里是你的旅行编年史——记录旅途中的每一个地点、照片和故事，世界地图也会随之逐渐点亮。",
    ko: "이곳은 당신의 여행 연대기예요. 여행지의 장소와 사진, 이야기를 기록하면 세계 지도가 조금씩 채워져요.",
    es: "Esta es tu crónica de viajes: registra cada lugar, foto e historia de tus viajes, y observa cómo se va llenando el mapa del mundo.",
    fr: "Voici votre chronique de voyage : enregistrez chaque lieu, photo et récit de vos voyages, et regardez la carte du monde se remplir peu à peu.",
    de: "Das ist deine Reisechronik — halte jeden Ort, jedes Foto und jede Geschichte deiner Reisen fest und beobachte, wie sich die Weltkarte nach und nach füllt.",
    pt: "Esta é sua crônica de viagens — registre cada lugar, foto e história das suas viagens, e veja o mapa-múndi se preencher aos poucos.",
  },
  ...
  "onboarding.profileBody": {
    en: "This is the name and emblem your party will see. You can always change it later from your Adventurer Card.",
    ja: "これはパーティーのみんなに見える名前と紋章です。あとから冒険者カードでいつでも変更できます。",
    zh: "这是队友们会看到的名字和徽记，之后也可以随时在冒险者卡中修改。",
    ko: "이건 파티원들에게 보여질 이름과 문장이에요. 나중에 모험가 카드에서 언제든 바꿀 수 있어요.",
    es: "Este es el nombre y el emblema que verá tu grupo. Siempre puedes cambiarlo después desde tu Carné de Aventurero.",
    fr: "Voici le nom et l'emblème que votre groupe verra. Vous pourrez toujours les modifier plus tard depuis votre Carte d'Aventurier.",
    de: "Das sind Name und Emblem, die deine Gruppe sieht. Du kannst sie später jederzeit über deine Abenteurerkarte ändern.",
    pt: "Este é o nome e o emblema que seu grupo verá. Você pode sempre alterá-los depois no seu Cartão de Aventureiro.",
  },
  ...
  "onboarding.tourDiaryBody": {
    en: "Write down what happened — add a location and the fog on the map clears too.",
    ja: "その日の出来事を書き残そう。場所を添えれば地図の霧も晴れる。",
    zh: "写下发生的事情——添加位置，地图上的迷雾也会随之消散。",
    ko: "그날 있었던 일을 적어보세요. 위치를 더하면 지도의 안개도 걷혀요.",
    es: "Anota lo que sucedió: añade una ubicación y también despejarás la niebla del mapa.",
    fr: "Notez ce qui s'est passé — ajoutez une position et le brouillard sur la carte se dissipera aussi.",
    de: "Halte fest, was passiert ist — füge einen Standort hinzu, und der Nebel auf der Karte lichtet sich ebenfalls.",
    pt: "Anote o que aconteceu — adicione uma localização e a névoa do mapa também vai se dissipar.",
  },
  ...
  "onboarding.tourPostBody": {
    en: "Trade cards with people you meet — a keepsake of everyone you've traveled alongside.",
    ja: "出会った人と名刺を交換しよう。いっしょに旅した仲間の証が、手元に残ります。",
    zh: "与遇到的人交换名片——留下与你同行过的每一位旅伴的纪念。",
    ko: "만난 사람들과 명함을 교환해요. 함께 여행한 모든 이의 기념이 손안에 남아요.",
    es: "Intercambia tarjetas con la gente que conozcas: un recuerdo de cada compañero de viaje.",
    fr: "Échangez des cartes avec les personnes que vous rencontrez — un souvenir de chaque compagnon de voyage.",
    de: "Tausche Karten mit Leuten, die du triffst — ein Andenken an jeden, mit dem du gereist bist.",
    pt: "Troque cartões com as pessoas que encontrar — uma lembrança de cada companheiro de viagem.",
  },
